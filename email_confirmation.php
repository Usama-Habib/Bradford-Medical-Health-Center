...
<div class="wrapper">
    <div class="container1">
         <h4 style="text-align: center; margin: 50px; ">We sent an email to  <b><?php echo $_GET['email'] ?></b> to help you recover your account.</h4>
        <p style="text-align: center">Please login into your email account and click on the link we sent to reset your password</p>
</div>
</div>
